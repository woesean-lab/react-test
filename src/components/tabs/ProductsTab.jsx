                    ...
                    >
                      ...
                      {isOpen && (
                        <div className="mt-4 space-y-4 border-t border-white/10 pt-4">
                                ...
                                {isOfferRefreshing ? (
                                  ...
                                  <>
                                    ...
                                    <div className="mt-5 border-t border-white/10 pt-5">
                                      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                                        <div className="rounded-xl border border-white/10 bg-ink-900/50 p-4">
                                          <label className="text-[12px] font-semibold text-slate-100">Not grubu</label>
                                          <div
                                        ...
                                        {canManageNotes && (
                                          <div className="rounded-xl border border-white/10 bg-ink-900/50 p-4">
                                            <label className="text-[12px] font-semibold text-slate-100">Yeni not grubu</label>
                                ...
                                <div className="space-y-4 rounded-2xl border border-white/10 bg-ink-900/50 p-4">
                                  {canCopyKeys && (
                                    <div className="flex flex-wrap items-center justify-between gap-3">
                                      <span className="text-[12px] font-semibold text-slate-100">Stoklar</span>
                                      <div className="flex flex-wrap items-center gap-2">
                          ...
                          <div className="self-start rounded-2xl border border-white/10 bg-ink-900/50 p-4">
                              <div>
